  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text('TOMATO', style: TextStyle(color: Colors.black),),
        actions: [
          InkWell(
            onTap: (){
              setState(() {
            ...
            Stack(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Image(image: AssetImage('images/MoreTomatos.png'),height: 350,)
                    ],
                  )
                ),
                Padding(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 3,),
                              Text('(97 Reviews)',style: TextStyle(color: Colors.grey, fontSize: 12),),
                              SizedBox(width: 150,),
                          ...
                          SizedBox(height: 8,),
                          Text('Fresh, ripe tomatoes bursting with flavor! Perfect for salads, sauces, and everyday cooking. Naturally grown and packed with nutrients',),
                          SizedBox(height: 150,),
                          Row(
                            children: [
                              Container(
