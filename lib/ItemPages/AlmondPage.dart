  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text('Almond', style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
        actions: [
          InkWell(
            onTap: (){
              setState(() {
            ...
            Stack(
              children: [
                Container(
                    ...
                    child: Column(
                      children: [
                        Image(image: AssetImage('images/almond.png'),height: 300,)
                      ],
                    )
                ),
                Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('Almond', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
                              Icon(CupertinoIcons.star_fill,color: Colors.orange,size: 15,),
                              SizedBox(width: 5,),
                              Text('4.7',style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                              SizedBox(width: 3,),
                              Text('(202 Reviews)',style: TextStyle(color: Colors.grey, fontSize: 12),),
                              SizedBox(width: 100,),
