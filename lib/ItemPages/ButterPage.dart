...
class ButterPage extends StatefulWidget {
  const ButterPage({super.key});

  @override
  State<ButterPage> createState() => _ButterPageState();
}

class _ButterPageState extends State<ButterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text('Butter', style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
        actions: [
          InkWell(
            onTap: (){
              setState(() {
            ...
            Stack(
              children: [
                Container(
                    ...
                    child: Column(
                      children: [
                        Image(image: AssetImage('images/butter.png'),height: 300,)
                      ],
                    )
                ),
                Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('Butter', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
                              Icon(CupertinoIcons.star_fill,color: Colors.orange,size: 15,),
                              SizedBox(width: 5,),
                              Text('4.8',style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                              SizedBox(width: 3,),
                              Text('(343 Reviews)',style: TextStyle(color: Colors.grey, fontSize: 12),),
                              SizedBox(width: 120,),
                              Text('\$8',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                              SizedBox(width: 5,),
                              Text('500 mg',style: TextStyle(fontSize: 12),),
                            ],
                          ),
                          SizedBox(height: 10,),
                          Text('Description',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          SizedBox(height: 8,),
                          Text('Crisp and colorful bell peppers, rich in flavor and vitamins. Perfect for salads, stir-fries, and healthy snacking.',),
                          SizedBox(height: 150,),
                          Row(
                            children: [
                              Container(
