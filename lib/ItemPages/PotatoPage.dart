...
class PotatoPage extends StatefulWidget {
  ...
  @override
  State<PotatoPage> createState() => _TomatoPageState();
}

class _TomatoPageState extends State<PotatoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text('POTATO', style: TextStyle(color: Colors.black),),
        actions: [
          InkWell(
            onTap: (){
              setState(() {
            ...
            Stack(
              children: [
                Container(
                    ...
                    child: Column(
                      children: [
                        Image(image: AssetImage('images/potato.png'),height: 350,)
                      ],
                    )
                ),
                Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('Potato', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
                              Icon(CupertinoIcons.star_fill,color: Colors.orange,size: 15,),
                              SizedBox(width: 5,),
                              Text('4.7',style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                              SizedBox(width: 3,),
                              Text('(108 Reviews)',style: TextStyle(color: Colors.grey, fontSize: 12),),
                              SizedBox(width: 150,),
                          ...
                          SizedBox(height: 8,),
                          Text('Fresh, firm potatoes perfect for boiling, frying, or baking. Packed with energy and farm-grown for delicious, everyday meals.',),
                          SizedBox(height: 150,),
                          Row(
                            children: [
                              Container(
