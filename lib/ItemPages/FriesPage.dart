  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text('French Fries', style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
        actions: [
          InkWell(
            onTap: (){
              setState(() {
            ...
            Stack(
              children: [
                Container(
                    ...
                    child: Column(
                      children: [
                        Image(image: AssetImage('images/fries.png'),height: 300,)
                      ],
                    )
                ),
                Padding(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 3,),
                              Text('(973 Reviews)',style: TextStyle(color: Colors.grey, fontSize: 12),),
                              SizedBox(width: 50,),
                              Text('\$10',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                              SizedBox(width: 5,),
                              Text('small cup',style: TextStyle(fontSize: 12),),
                            ],
                          ),
                          SizedBox(height: 10,),
