...
class CabbagePage  extends StatefulWidget {
  ...
  @override
  State<CabbagePage> createState() => _TomatoPageState();
}

class _TomatoPageState extends State<CabbagePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: Text('Cabbage', style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
        actions: [
          InkWell(
            onTap: (){
              setState(() {
            ...
            Stack(
              children: [
                Container(
                    ...
                    child: Column(
                      children: [
                        Image(image: AssetImage('images/Cabbage.png'),height: 300,)
                      ],
                    )
                ),
                Padding(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('Cabbage', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                              SizedBox(width: 10,),
                              Icon(CupertinoIcons.star_fill,color: Colors.orange,size: 15,),
                              SizedBox(width: 5,),
                              Text('4.8',style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                              SizedBox(width: 3,),
                              Text('(167 Reviews)',style: TextStyle(color: Colors.grey, fontSize: 12),),
                              SizedBox(width: 100,),
                          ...
                          SizedBox(height: 8,),
                          Text('Fresh, crunchy cabbage packed with nutrients. Perfect for salads, stir-fries, and hearty home-cooked meals.',),
                          SizedBox(height: 150,),
                          Row(
                            children: [
                              Container(
